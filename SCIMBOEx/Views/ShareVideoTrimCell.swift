...
protocol ShareVideoTrimCellDelegate : class {
    func updateTrimDetails(_ ObjMultimedia : MultimediaRecord)
}

class ShareVideoTrimCell: UICollectionViewCell,ICGVideoTrimmerDelegate {
    weak var delegate : ShareVideoTrimCellDelegate?
    ...
    func trimmerView(_ trimmerView: ICGVideoTrimmerView, didChangeLeftPosition startTime: CGFloat, rightPosition endTime: CGFloat) {
        ...
        delegate?.updateTrimDetails(ObjMultimedia)
    }
