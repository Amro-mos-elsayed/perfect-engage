...
class ChatsTableViewCell: MGSwipeTableCell {
    ...
    override func awakeFromNib() {
        ...
        name_Lbl.textAlignment = NSTextAlignment.left
       //internalTextView.textAlignment = [language  isEqualToString: @"ar"] ? NSTextAlignmentRight : NSTextAlignmentLeft;
    }
