...
+(void)showImage:(UIImageView *)avatarImageView orgimage:(UIImage *)orgimage{
    UIImage *image;
    if(orgimage != nil)
    {
        image = orgimage;
    ...
    backgroundView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleBottomMargin |
