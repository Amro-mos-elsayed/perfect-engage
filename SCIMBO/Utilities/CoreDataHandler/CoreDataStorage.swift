...
open class CoreDataStorage {
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
		...
		let modelURL = Bundle.main.url(forResource: "Chat", withExtension: "mom")!
	...
	lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let directory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: Constant.sharedinstance.AppGroupID)!
		let url = directory.appendingPathComponent("Chat.sqlite")
		do {
