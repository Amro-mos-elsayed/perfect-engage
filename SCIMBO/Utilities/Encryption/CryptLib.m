...
- (NSString *) encryptPlainTextWith:(NSString *)plainText key:(NSString *)key iv:(NSString *)iv {
    return [[[[StringEncryption alloc] init] encrypt:[plainText dataUsingEncoding:NSUTF8StringEncoding] key:[[StringEncryption alloc] sha256:key length:32] iv:iv] base64EncodedStringWithOptions:0];
}

//- (NSString *) encryptPlainTextWith:(NSString *)plainText key:(NSString *)key iv:(NSString *)iv {
//        return [[[[StringEncryption alloc] init] encrypt:[plainText dataUsingEncoding:NSUTF8StringEncoding] key:key iv:iv] base64EncodedStringWithOptions:0];
//    }
...
- (NSString *) decryptCipherTextWith:(NSString *)ciperText key:(NSString *)key iv:(NSString *)iv {
        return [[NSString alloc] initWithData:[[StringEncryption alloc] decrypt:[[NSData alloc] initWithBase64EncodedString:ciperText options:NSDataBase64DecodingIgnoreUnknownCharacters] key:[[StringEncryption alloc] sha256:key length:32] iv:iv] encoding:NSUTF8StringEncoding];
    }
