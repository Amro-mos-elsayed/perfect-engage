...
static NSString * const kARDRoomServerHostUrl = BASE_URL;
static NSString * const kARDRoomServerJoinFormat = BASE_URL @"/join/%@";
static NSString * const kARDRoomServerJoinFormatLoopback = BASE_URL @"/join/%@?debug=loopback";
static NSString * const kARDRoomServerMessageFormat = BASE_URL @"/message/%@/%@";
static NSString * const kARDRoomServerLeaveFormat = BASE_URL @"/leave/%@/%@";
