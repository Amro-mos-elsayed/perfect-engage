...
SWIFT_MODULE_NAMESPACE_PUSH("GTSheet")
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC7GTSheet12DismissBarVC")
...
SWIFT_CLASS("_TtC7GTSheet17DismissalAnimator")
...
SWIFT_CLASS("_TtC7GTSheet28HalfSheetPresentationManager")
...
@interface HalfSheetPresentationManager (SWIFT_EXTENSION(GTSheet)) <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC7GTSheet26PresentationViewController")
...
@interface PresentationViewController (SWIFT_EXTENSION(GTSheet)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC7GTSheet28VerticalPanGestureRecognizer")
