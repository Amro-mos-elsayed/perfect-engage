...
public final class AttributeManager {
    ...
    func attributedText(_ string: String) -> NSAttributedString {
        let attributes: [NSAttributedString.Key : Any] = [
            (NSAttributedString.Key.font as NSString) as NSAttributedString.Key : font,
            (NSAttributedString.Key.foregroundColor as NSString) as NSAttributedString.Key : fontColor
        ]
