...
public struct Configuration {
    ...
    public var mainColor = UIColor.clear
    //    UIColor(red: 0.09, green: 0.11, blue: 0.13, alpha: 1)
    ...
    public var userDisplayLabelColor = UIColor.white
    ...
    public var userDescriptionLabelFont = UIFont.systemFont(ofSize: 13, weight: UIFont.Weight.medium)
